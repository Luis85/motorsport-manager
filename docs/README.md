...
Current native implementation: **0.13.0** · **Godot 4.7.2 Standard**.
...
| [Persistence](persistence.md) | Session/replay v1, scenario v1 and native v10; see the 0.13 handoff for current validation |
