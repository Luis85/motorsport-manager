...
Current native implementation: **0.11.0** · **Godot 4.7.2 Standard**.

| Document | Purpose |
|---|---|
| [Contextual rivals and calmer pit wall](race-weekend-rivals.md) | Current partial RW-18, native UI refinement, checkpoint v10 and explicit pressure deferral |
...
| [Persistence](persistence.md) | Atomic saves and base checkpoint migrations; see the 0.11 handoff for current v10 |
