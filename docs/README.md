...
| Document | Purpose |
|---|---|
| [Compact UI and performance](ui-performance-iteration.md) | Current 0.8 task navigation, pinned actions, interaction safety, paired measurements and 1,388-check verification |
