...
func show_weekend() -> void:
	...
	var view = RecoveryWeekendView.new() if App.weekend is RecoveryRaceSim else WeatherWeekendView.new() if App.weekend is WeatherRaceSim else (StrategyWeekendView.new() if App.weekend is StrategyRaceSim else WeekendView.new())
