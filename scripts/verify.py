        ...
        with tempfile.TemporaryDirectory(prefix="motorsport-manager-verification-") as user_dir:
            ...
            if not args.headless_only:
                ...
                try:
                    ...
                    for phase, script in [("rivals-ui", "rivals_ui_tests.gd"), ("workspace-performance", "workspace_performance.gd"), ("replay-ui", "replay_ui_tests.gd"), ("notebook-ui", "notebook_ui_tests.gd")]:
            ...
            summary = {"passed": True, "mode": "headless-only" if args.headless_only else "full",
                       "notebook_checks": notebook["checks"], "notebook_ui_checks": notebook_ui["checks"] if notebook_ui else None,
                       ...
                       "screenshots": (notebook_ui["screenshots"] + replay_ui["screenshots"] + rivals_ui["screenshots"] + practice_ui["screenshots"] + recovery_ui["screenshots"] + pitwall_ui["screenshots"] + compact_ui["screenshots"] + ui["screenshots"] + strategy_ui["screenshots"] + living_ui["screenshots"] + weather_ui["screenshots"]) if ui else 0}
